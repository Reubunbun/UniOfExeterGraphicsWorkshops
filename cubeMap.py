...
class FlattenCubeMap(DrawModelFromMesh):
    ...
    def __init__(self, scene, cube=None):
        ...
        DrawModelFromMesh.__init__(self, scene=scene, M=poseMatrix(position=[0,0,+1]), mesh=mesh, shader=FlattenedCubeShader())
...
class CubeMap(Texture):
    ...
    '''
    def __init__(self, scene, name=None, files=None, wrap=GL_CLAMP_TO_EDGE, sample=GL_LINEAR, format=GL_RGBA, type=GL_UNSIGNED_BYTE):
        '''
        ...
        self.files = {
            ...
            GL_TEXTURE_CUBE_MAP_POSITIVE_Z: 'front.bmp',
            GL_TEXTURE_CUBE_MAP_POSITIVE_X: 'right.bmp',
            GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: 'back.bmp',
